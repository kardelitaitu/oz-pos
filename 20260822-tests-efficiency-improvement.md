...
| A35 e2e remaining | 465 (7m45s) | 391 (6m31s, −16%) | 369 (6m9s, −20.7%) | 327 (5m27s, −29.7%) | round 1: cut50 waits (adr22, sale, settings). round 2: −52 more (inventory-workflows 18, settings-persist 15, refund 10, kds-critical-path 9). round 3: shift.spec.ts 22 waits → deterministic assertions (41.7s for 12 tests) |
