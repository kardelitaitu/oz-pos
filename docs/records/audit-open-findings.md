...
**Status:** LOY-01 remediated; **LOY-06 CLOSED 2026-08-30** (earn now fires atomically at completion); SF-01 (found on the same path) closed with it.
...
- **LOY-03** — No refund or void compensation path for earned points — **now a live gap** (LOY-06 closed: points ARE being awarded; refunds/voids still never reverse them)
