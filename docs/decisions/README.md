...
| 45 | [Topology Semantic Contract v2 — Endpoint Predicates, Kind Registry, Deliberate Cold Start, and Theme Parity](./2026-09-02-adr45-topology-semantic-contract-v2.md) | §1–§3, §4.1, §5, §4.2 backend + storage + migration, §4.3 ordering rule Implemented (2026-09-02) · §4.2 UI swap, §4.3 checklist UI Proposed |
