...
<!-- Audit stamp: 2026-07-26 · Hermes-Agent · status: STALE (see below) · 2026-07-31 KNOWN-STALE — this doc was generated from an early IPC snapshot and has not been regenerated to reflect the _scoped ADR #7 migration or the dozens of new KDS/workspace/topology commands added since. Do NOT use this doc to discover available IPC calls — read from ui/src/api/*.ts or the generate_handler! list in apps/desktop-client/src/commands/ instead. -->
