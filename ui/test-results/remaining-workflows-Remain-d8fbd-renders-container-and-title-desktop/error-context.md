...
- Name: remaining-workflows.spec.ts >> Remaining Workflow Screens >> Sales Dashboard renders container and title
- Location: e2e\remaining-workflows.spec.ts:72:3
...
Locator: locator('.reporting-dashboard')
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for locator('.reporting-dashboard')
