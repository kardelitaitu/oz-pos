...
- Name: inventory-workflows.spec.ts >> Inventory Workflows >> suppliers screen renders with table
- Location: e2e\inventory-workflows.spec.ts:53:3
...
Locator: locator('.suppliers-screen')
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for locator('.suppliers-screen')
