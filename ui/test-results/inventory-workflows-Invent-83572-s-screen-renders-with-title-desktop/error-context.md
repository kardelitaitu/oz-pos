...
- Name: inventory-workflows.spec.ts >> Inventory Workflows >> stock transfers screen renders with title
- Location: e2e\inventory-workflows.spec.ts:36:3
...
Locator: locator('.stock-transfers')
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for locator('.stock-transfers')
