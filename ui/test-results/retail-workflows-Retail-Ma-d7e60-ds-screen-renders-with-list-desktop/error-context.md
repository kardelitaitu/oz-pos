...
- Name: retail-workflows.spec.ts >> Retail & Management Screens >> Gift Cards screen renders with list
- Location: e2e\retail-workflows.spec.ts:45:3
...
Locator: locator('.gift-cards-page')
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for locator('.gift-cards-page')
