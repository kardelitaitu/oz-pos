...
- Name: remaining-workflows.spec.ts >> Remaining Workflow Screens >> Inventory Adjustment renders search and sections
- Location: e2e\remaining-workflows.spec.ts:32:3
...
Call log:
  ...
  - waiting for locator('.inv-adjust')
