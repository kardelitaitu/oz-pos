...
- Name: reporting-workflows.spec.ts >> Reporting Screens >> Inventory Report renders table with threshold control
- Location: e2e\reporting-workflows.spec.ts:61:3
...
Locator: locator('.inventory-report')
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for locator('.inventory-report')
