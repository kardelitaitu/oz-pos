...
- Name: reporting-workflows.spec.ts >> Reporting Screens >> Sales Report renders chart cards and controls
- Location: e2e\reporting-workflows.spec.ts:46:3
...
Call log:
  ...
  - waiting for locator('.sales-report')
