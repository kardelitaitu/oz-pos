...
customer-mgmt-modal-add-aria = Tambah pelanggan
customer-mgmt-modal-edit-aria = Ubah pelanggan
...
customer-mgmt-error-email-invalid = Masukkan alamat email yang valid
customer-mgmt-error-phone-invalid = Telepon harus memuat setidaknya satu angka
customer-mgmt-error-notes-too-long = Catatan maksimal 500 karakter
