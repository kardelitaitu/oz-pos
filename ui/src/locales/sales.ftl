...
sales-history-search-placeholder = Search sale ID, payment, cashier…
sales-history-search-aria = Search sales
sales-history-status-label = Status
sales-history-filter-aria = Filter by status
sales-history-from-label = From
sales-history-to-label = To
sales-history-from-aria = From date
sales-history-to-aria = To date
sales-history-cashier-label = Cashier
sales-history-cashier-aria = Filter by cashier
sales-history-cashier-all = All Cashiers
sales-history-clear-filters = Clear filters
sales-history-prev-page = ← Prev
sales-history-prev-aria = Previous page
sales-history-next-page = Next →
sales-history-next-aria = Next page
sales-history-per-page-label = Per page
sales-history-per-page-aria = Results per page
...
sales-history-void-reason-placeholder = e.g. Customer cancellation
sales-history-void-reason-aria = Void reason
sales-history-void-cancel = Cancel
sales-history-void-confirm = Confirm Void
sales-history-void-progress = Voiding…
sales-history-void-close-aria = Close void dialog
