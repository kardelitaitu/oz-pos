...
workspace-home-greeting-morning = Selamat pagi, { $name }
workspace-home-greeting-afternoon = Selamat siang, { $name }
workspace-home-greeting-evening = Selamat sore, { $name }
workspace-home-greeting-night = Selamat malam, { $name }
