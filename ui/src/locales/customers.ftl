...
customer-mgmt-modal-add-aria = Add customer
customer-mgmt-modal-edit-aria = Edit customer
...
customer-mgmt-history-aria = View history for { $name }
...
customer-mgmt-history-sale-date = Date
