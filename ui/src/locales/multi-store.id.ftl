...
topology-wire-routing-toggle = Kabel siku
topology-bends-override-note = Titik tekuk menggantikan mode rute pada kabel yang dilengkungkan
...
topology-wire-labels-toggle = Label kabel
...
topology-context-delete-wire = Hapus kabel
topology-context-rename-wire = Ganti nama kabel
topology-wire-rename-placeholder = Label kabel
...
topology-confirm-delete-many-msg = Hapus { $count } node dan semua kabelnya? Tindakan ini tidak dapat dibatalkan.
