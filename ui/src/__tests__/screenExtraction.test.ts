...
const SCREENS: ScreenEntry[] = [
  ...
  // ── Settings ──────────────────────────────────────────
  {
    ...
    externalClasses: ['card', 'tab-list', 'tooltip-content', 'feature-toggle', 'data-mgmt',
      'staff-mgmt', 'terminal-mgmt', 'multi-store-dashboard', 'audit-log', 'offline-queue-screen',
      'shift-mgmt', 'tax-config', 'exchange-rate-config', 'promo-mgmt'],
  },
  {
  ...
  // ── Appearance Settings ────────────────────────────────
  {
    ...
    externalClasses: [
      ...
      'settings-error',
      'settings-sync-result-block',
      'settings-license-section',
      'settings-license-row',
      'settings-license-row--last',
      'settings-license-label',
      'settings-license-value',
      'settings-license-value--mono',
      'settings-license-value--warning',
      'settings-license-value--medium',
      // New layout classes from SettingsPage.css (not referenced by AppearanceSettings)
      'tooltip-content',
      'settings-topbar',
      'settings-topbar-left',
      'settings-topbar-icon',
      'settings-topbar-name',
      'settings-topbar-right',
      'settings-topbar-clock',
      'settings-body',
      'settings-sidebar',
      'collapsed',
      'settings-nav-label',
      ...
      'settings-sidebar-section-header--active',
