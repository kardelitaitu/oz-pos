...
vi.mock('@/api/inventoryCounts', () => ({
  ...
  completeStockCount: (...args) => mockComplete(...args),
  completeStockCountScoped: (...args) => mockComplete(...args),
  updateStockCountStatus: (...args) => mockUpdateStatus(...args),
  updateStockCountStatusScoped: (...args) => mockUpdateStatus(...args),
