...
export type AppRoute = 'design' | 'sales' | 'products' | 'inventory' | 'inventory-adjustment' | 'settings' | 'categories' | 'sales-history' | 'sales-dashboard' | 'eod-report' | 'tax-config' | 'features' | 'data-management' | 'orders' | 'staff' | 'customers' | 'audit-log' | 'exchange-rates';
