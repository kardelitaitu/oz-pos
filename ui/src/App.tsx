...
registerNavItem({ route: 'custom-report', label: 'Custom Report', requiredRole: 'manager', i18nKey: 'nav-custom-report', section: 'reports',
  icon: icon('M12 20h9', <path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z" />) });
registerNavItem({ route: 'menu-engineering', label: 'Menu Engineering', feature: 'restaurant', requiredRole: 'manager', i18nKey: 'nav-menu-engineering', section: 'reports',
