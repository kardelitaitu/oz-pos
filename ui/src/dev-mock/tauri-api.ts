...
const MOCK_PRODUCTS = [
  { sku: 'LATTE', name: 'Caff\u00e8 Latte', category: 'cat-hot-drinks', price: { minor_units: 450, currency: 'USD' }, barcode: '4901234567890', in_stock: true, stock_qty: 50, tax_rate_ids: [], created_at: new Date().toISOString(), price_updated_at: new Date().toISOString(), product_type: 'retail' },
  { sku: 'MLATTE', name: 'Matcha Latte', category: 'cat-hot-drinks', price: { minor_units: 520, currency: 'USD' }, barcode: '4901234567891', in_stock: true, stock_qty: 30, tax_rate_ids: [], created_at: new Date().toISOString(), price_updated_at: new Date().toISOString(), product_type: 'retail' },
  { sku: 'ESPR', name: 'Espresso Shot', category: 'cat-hot-drinks', price: { minor_units: 300, currency: 'USD' }, barcode: '4901234567892', in_stock: true, stock_qty: 80, tax_rate_ids: [], created_at: new Date().toISOString(), price_updated_at: new Date().toISOString(), product_type: 'retail' },
  { sku: 'HCHOCO', name: 'Hot Chocolate', category: 'cat-hot-drinks', price: { minor_units: 420, currency: 'USD' }, barcode: '4901234567893', in_stock: true, stock_qty: 25, tax_rate_ids: [], created_at: new Date().toISOString(), price_updated_at: new Date().toISOString(), product_type: 'retail' },
  { sku: 'ICCOFF', name: 'Iced Coffee', category: 'cat-cold-drinks', price: { minor_units: 380, currency: 'USD' }, barcode: '4901234567894', in_stock: true, stock_qty: 40, tax_rate_ids: [], created_at: new Date().toISOString(), price_updated_at: new Date().toISOString(), product_type: 'retail' },
  { sku: 'ICTEA', name: 'Iced Tea', category: 'cat-cold-drinks', price: { minor_units: 250, currency: 'USD' }, barcode: '4901234567895', in_stock: true, stock_qty: 60, tax_rate_ids: [], created_at: new Date().toISOString(), price_updated_at: new Date().toISOString(), product_type: 'retail' },
  { sku: 'JUICE-O', name: 'Orange Juice', category: 'cat-cold-drinks', price: { minor_units: 350, currency: 'USD' }, barcode: '4901234567904', in_stock: true, stock_qty: 20, tax_rate_ids: [], created_at: new Date().toISOString(), price_updated_at: new Date().toISOString(), product_type: 'retail' },
  { sku: 'LEMONADE', name: 'Lemonade', category: 'cat-cold-drinks', price: { minor_units: 300, currency: 'USD' }, barcode: '4901234567897', in_stock: true, stock_qty: 35, tax_rate_ids: [], created_at: new Date().toISOString(), price_updated_at: new Date().toISOString(), product_type: 'retail' },
  { sku: 'PBAGEL', name: 'Plain Bagel', category: 'cat-food', price: { minor_units: 250, currency: 'USD' }, barcode: '4901234567898', in_stock: true, stock_qty: 15, tax_rate_ids: [], created_at: new Date().toISOString(), price_updated_at: new Date().toISOString(), product_type: 'retail' },
  { sku: 'SBAGEL', name: 'Sesame Bagel', category: 'cat-food', price: { minor_units: 280, currency: 'USD' }, barcode: '4901234567899', in_stock: true, stock_qty: 12, tax_rate_ids: [], created_at: new Date().toISOString(), price_updated_at: new Date().toISOString(), product_type: 'retail' },
  { sku: 'CROISS', name: 'Butter Croissant', category: 'cat-food', price: { minor_units: 320, currency: 'USD' }, barcode: '4901234567800', in_stock: true, stock_qty: 18, tax_rate_ids: [], created_at: new Date().toISOString(), price_updated_at: new Date().toISOString(), product_type: 'retail' },
  { sku: 'CSAND', name: 'Chicken Sandwich', category: 'cat-food', price: { minor_units: 550, currency: 'USD' }, barcode: '4901234567801', in_stock: true, stock_qty: 10, tax_rate_ids: [], created_at: new Date().toISOString(), price_updated_at: new Date().toISOString(), product_type: 'retail' },
  { sku: 'VSAND', name: 'Veggie Sandwich', category: 'cat-food', price: { minor_units: 480, currency: 'USD' }, barcode: '4901234567802', in_stock: true, stock_qty: 8, tax_rate_ids: [], created_at: new Date().toISOString(), price_updated_at: new Date().toISOString(), product_type: 'retail' },
  { sku: 'WATER-S', name: 'Sparkling Water', category: 'cat-cold-drinks', price: { minor_units: 180, currency: 'USD' }, barcode: '4901234567803', in_stock: true, stock_qty: 150, tax_rate_ids: [], created_at: new Date().toISOString(), price_updated_at: new Date().toISOString(), product_type: 'retail' },
  { sku: 'BROWNIE', name: 'Fudge Brownie', category: 'cat-snacks', price: { minor_units: 300, currency: 'USD' }, barcode: '4901234567804', in_stock: false, stock_qty: 0, tax_rate_ids: [], created_at: new Date().toISOString(), price_updated_at: new Date().toISOString(), product_type: 'retail' },
  { sku: 'CMUFFIN', name: 'Chocolate Muffin', category: 'cat-snacks', price: { minor_units: 280, currency: 'USD' }, barcode: '4901234567805', in_stock: false, stock_qty: 0, tax_rate_ids: [], created_at: new Date().toISOString(), price_updated_at: new Date().toISOString(), product_type: 'retail' },
  { sku: 'NUTS', name: 'Mixed Nuts', category: 'cat-snacks', price: { minor_units: 400, currency: 'USD' }, barcode: '4901234567806', in_stock: true, stock_qty: 22, tax_rate_ids: [], created_at: new Date().toISOString(), price_updated_at: new Date().toISOString(), product_type: 'retail' },
  { sku: 'CHIPS', name: 'Potato Chips', category: 'cat-snacks', price: { minor_units: 200, currency: 'USD' }, barcode: '4901234567807', in_stock: true, stock_qty: 55, tax_rate_ids: [], created_at: new Date().toISOString(), price_updated_at: new Date().toISOString(), product_type: 'retail' },
];
