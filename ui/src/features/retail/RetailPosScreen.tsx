...
export default function RetailPosScreen() {
  ...
  return (
    <div className="retail-pos" data-theme={theme}>
      ...
      {/* ── Open Shift modal ────────────────── */}
      {showOpenShift && (
        <div className="retail-shift-overlay" onClick={() => setShowOpenShift(false)} onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); setShowOpenShift(false); } }}>
      ...
      {showCloseShift && activeShift && !closedShiftSummary && (
        <div className="retail-shift-overlay" onClick={() => setShowCloseShift(false)} onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); setShowCloseShift(false); } }}>
          <div className="retail-shift-modal" onClick={(e) => e.stopPropagation()}>
      ...
      {/* ── Credit list overlay ─────────────── */}
      {showCreditList && (
        <div className="retail-shift-overlay" onClick={() => setShowCreditList(false)} onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); setShowCreditList(false); } }}>
      ...
      {/* ── Clear confirm modal ────────────── */}
      {showClearConfirm && (
        <div className="retail-shift-overlay" onClick={() => setShowClearConfirm(false)} onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); setShowClearConfirm(false); } }}>
          <div className="retail-shift-modal" onClick={(e) => e.stopPropagation()}>
      ...
      {/* ── Discount modal ──────────────────── */}
      {showDiscount && (
        <div className="retail-discount-overlay" onClick={() => setShowDiscount(false)} onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); setShowDiscount(false); } }}>
      ...
      {showCustomerSearch && (
        <div className="retail-customer-overlay" onClick={() => setShowCustomerSearch(false)} onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); setShowCustomerSearch(false); } }}>
      ...
      {showQtyPicker && pendingProduct && (
        <div className="retail-qty-overlay" onClick={() => setShowQtyPicker(false)} onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); setShowQtyPicker(false); } }}>
      ...
      {showHeldCartsList && (
        <div className="retail-held-carts-overlay" onClick={() => setShowHeldCartsList(false)} onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); setShowHeldCartsList(false); } }}>
              ...
              <div className="retail-held-carts-list">
                {heldCartsList.map((c) => (
                  <div key={c.id} className="retail-held-cart-row">
                    <div className="retail-held-cart-info" onClick={() => handleResumeCart(c.id)} onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); handleResumeCart(c.id); } }}>
      ...
      {/* ── Shortcuts overlay ──────────────── */}
      {showShortcuts && (
        <div className="retail-shortcuts-overlay" onClick={() => setShowShortcuts(false)} onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); setShowShortcuts(false); } }}>
      ...
      {/* ── Quick Return modal ──────────────── */}
      {showQuickReturn && (
        <div className="retail-shift-overlay" onClick={() => { setShowQuickReturn(false); setQuickReturnBarcode(''); }} onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); setShowQuickReturn(false); setQuickReturnBarcode(''); } }}>
          <div className="retail-shift-modal" onClick={(e) => e.stopPropagation()}>
