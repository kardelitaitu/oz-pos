...
INSERT INTO currencies (code, numeric_code, name, minor_exponent, symbol) VALUES
    ('USD', '840', 'US Dollar',    2, '$'),
...
INSERT INTO store_profiles (id, name, is_primary)
VALUES ('default', 'Default Store', 0)
ON CONFLICT DO NOTHING;

-- Loyalty tiers (from migration 031)

INSERT INTO loyalty_tiers (id, name, min_points, points_per_unit, earn_multiplier, colour, sort_order) VALUES
...
INSERT INTO workspace_screens (workspace_key, screen_key, sort_order) VALUES
...
INSERT INTO workspace_type_screens (type_key, screen_key, sort_order) VALUES
    ('restaurant-pos', 'sales', 1),
    ('restaurant-pos', 'kds', 2),
    ('restaurant-pos', 'orders', 3),
    ('restaurant-pos', 'tables', 4),
...
INSERT INTO workspace_instances (id, type_key, store_id, name, description, colour, status, last_accessed_at) VALUES
    ('default-restaurant-pos', 'restaurant-pos', 'default', 'Restaurant POS', 'Cashier terminal for restaurant ordering', NULL, 'active', to_char(now() AT TIME ZONE 'UTC', 'YYYY-MM-DD"T"HH24:MI:SS.MS"Z"')),
    ('default-store-pos', 'store-pos', 'default', 'Store POS', 'Cashier terminal for retail', NULL, 'active', to_char(now() AT TIME ZONE 'UTC', 'YYYY-MM-DD"T"HH24:MI:SS.MS"Z"')),
    ('default-warehouse', 'warehouse', 'default', 'Warehouse', 'Product and stock management', NULL, 'active', to_char(now() AT TIME ZONE 'UTC', 'YYYY-MM-DD"T"HH24:MI:SS.MS"Z"')),
    ('default-admin', 'admin', 'default', 'Admin', 'System administration', NULL, 'active', to_char(now() AT TIME ZONE 'UTC', 'YYYY-MM-DD"T"HH24:MI:SS.MS"Z"')),
    ('default-kds', 'kds', 'default', 'Kitchen Display', 'Kitchen order queue display', NULL, 'active', to_char(now() AT TIME ZONE 'UTC', 'YYYY-MM-DD"T"HH24:MI:SS.MS"Z"'))
ON CONFLICT DO NOTHING;

-- Default tenant subscription (from migration 061)

INSERT INTO tenant_subscription (tenant_id, tier_key, status, expires_at, max_stores, max_pos_instances, allowed_types_json, signature)
