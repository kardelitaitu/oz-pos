  ...
  return (
    <div className="grid h-full grid-cols-12 gap-4 p-6">
      ...
      <div className="col-span-2 space-y-3">
        <div className="rounded-lg border border-ink/5 bg-white/80 p-3 shadow-sm">
      ...
      <div className="col-span-7 space-y-4">
        ...
        <div className="flex gap-2">
          <span className="rounded-full bg-accent px-4 py-2 text-xs font-medium text-white">Semua</span>
          <span className="rounded-full border border-ink/10 bg-white/80 px-4 py-2 text-xs text-muted">Kopi</span>
          <span className="rounded-full border border-ink/10 bg-white/80 px-4 py-2 text-xs text-muted">Makanan</span>
          <span className="rounded-full border border-ink/10 bg-white/80 px-4 py-2 text-xs text-muted">Minuman</span>
          <span className="rounded-full border border-ink/10 bg-white/80 px-4 py-2 text-xs text-muted">Camilan</span>
        </div>
        ...
        <div className="grid grid-cols-4 gap-3">
          {[
            ...
            <div
              key={name}
              className="mockup-card cursor-pointer rounded-xl border border-ink/5 bg-white/90 p-4 shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:border-accent/30 hover:shadow-md"
            >
      ...
      <div className="col-span-3">
        <div className="flex h-full flex-col rounded-xl border border-ink/5 bg-white/90 p-4 shadow-sm">
          ...
          <div className="space-y-3 border-t border-ink/10 pt-3">
            ...
            <div className="mockup-btn cursor-pointer rounded-lg bg-gradient-to-r from-blue-500 to-blue-600 py-3 text-center text-sm font-bold text-white shadow-md transition-all duration-[120ms] ease-[cubic-bezier(0.2,0,0,1)] hover:scale-[1.03] hover:shadow-lg active:scale-[0.97]">
              Bayar · QRIS
            </div>
          </div>
        </div>
