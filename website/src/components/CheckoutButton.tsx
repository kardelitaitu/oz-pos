  ...
  return (
    <div className="space-y-2">
      <button
        ...
        disabled={loading}
        className="block w-full rounded-md bg-accent px-4 py-2.5 text-center text-sm font-semibold text-white whitespace-nowrap transition hover:opacity-90 disabled:opacity-60"
      >
