...
14. LocationPicker / LocationManagement — location CRUD, picker UX — ✅ **REMEDIATED** (all 10 findings LOC-01→LOC-10; see [14-location-management.md](14-location-management.md) — commits `fb1842ce`, `e943095b`, `451747b6`, `4b227e4f`, `5ee88824`, `688dca10`, `815bd1aa`, `3caddf6e`)
15. TableManagement — Restaurant table layouts, drag-and-drop, floor plans — ✅ **REMEDIATED** (all 12 findings TBL-01→TBL-12; see [15-table-management.md](15-table-management.md) — commits `6f2e3ce4`, `9d8bab79`)
...
25. Rust backend — clippy warnings, unsafe blocks, error propagation, API coherence — ✅ **FULLY REMEDIATED** (all 10 findings RUST-01→RUST-10; see [25-rust-backend.md](25-rust-backend.md) — commits `af8a6660`, `90a74c8d`, `0f4192db`, `a16c3baf`, `d82b133d`, `6f7307b3`, `96e12986`; RUST-01 verified via the SYNC-04 dispatch pipeline)
...
27. CI pipeline — gate completeness, flaky test quarantine, cache efficiency — ✅ **FULLY REMEDIATED** (all 10 findings CI-01→CI-10; see [27-ci-pipeline.md](27-ci-pipeline.md) — remediation batch committed as `fbd83866` on 2026-08-03)
28. Release process — versioning, changelog automation, artifact signing — ✅ **FULLY REMEDIATED** (all findings closed; see [28-release-process.md](28-release-process.md) — Windows config drift gate batch committed as `f45618ea` on 2026-08-03)
29. Database migrations — idempotency, rollback coverage, index coverage, schema docs — ✅ **FULLY REMEDIATED** (all 8 findings DB-01→DB-08; see [29-database-migrations.md](29-database-migrations.md) — commit `06f0a949`: runner checksums + FK isolation, migration 116 unique version, registry parity, populated upgrade fixtures; DB-04 end-state implemented as migration 117 store_id FK + orphan quarantine)
