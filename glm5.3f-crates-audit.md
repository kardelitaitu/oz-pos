...
**Slice D remainder (next):** `admin_stats.go` (394), `pause.go`/`resume.go`/`expiry.go` (186), `contact.go` (176), `smtp_mail.go` (201), `health.go` (198), `enterprise_trial.go` (170), `trial_emails.go` remainder — then the build-artifact hygiene check.
