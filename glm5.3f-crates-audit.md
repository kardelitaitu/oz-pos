...
**Slice D remainder (next):** `admin_stats.go` (394), `contact.go` (176), `smtp_mail.go` (201), `health.go` (198), `trial_emails.go` remainder — then the build-artifact hygiene check.
