...
//!
//! Moved verbatim from topology.rs's `mod tests` so the command module stays
//! under the repo's ~3k-line file guideline. `use super::*` keeps the exact
//! module scope the tests always had — topology.rs still owns all the
//! production code this file exercises.
