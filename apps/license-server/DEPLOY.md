...
- [ ] **Go 1.23+** and **OpenSSL** installed locally (for key generation and testing)
...
The `Dockerfile` uses a **multi-stage build**: `golang:1.23-alpine` compiles the binary, then copies it into `alpine:3.20` for a ~25 MB final image.
